...
namespace App_Shipper.DAL
{
    public class DonHangDAL
    {
        ...
        public bool CapNhatTrangThaiDon(string maDonHang, string trangThaiMoi)
        {
        ...
        public DataTable PollTrangThaiDonHangMoiNhat(string maShipper)
        {
            ...
            SqlParameter[] parameters = new SqlParameter[]
            {
              new  SqlParameter("@maKhachHang", maShipper)
            };
            return DatabaseHelper.ExecuteQuery(query, parameters);
        }
        ...
        public bool GiaoDonHang(string maDonHang)
        {
            ...
            {
                new SqlParameter("@TrangThaiDonHang", "Đã giao"),
                new SqlParameter("@MaDonHang", maDonHang)
            };
        ...
        public List<DonHangDTO> LayDanhSachDonHangGop(string maShipper)
        {
            ...
            string query = @"
                ...
                WHERE MaShipper = @MaShipper AND dh.TrangThaiDonHang != N'Gặp sự cố'
        ...
        {
            string query = "SELECT COUNT(*) FROM DON_HANG WHERE MaShipper = @MaShipper AND TrangThaiDonHang != N'Gặp sự cố'";
            SqlParameter[] parameters = new SqlParameter[]
            {
                new SqlParameter("@MaShipper", maShipper)
            };
