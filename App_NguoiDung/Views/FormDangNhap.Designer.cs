namespace App_NguoiDung.Views
{
    partial class FormDangNhap
    {
        ...
        private void InitializeComponent()
        {
            ...
            // panel1
            // 
            panel1.BackgroundImage = Properties.Resources.customer_loggin;
            ...
            // btnDangKy
            // 
            btnDangKy.BackColor = Color.FromArgb(0, 0, 0, 0);
            btnDangKy.BackgroundImage = (Image)resources.GetObject("btnDangKy.BackgroundImage");
            btnDangKy.BackgroundImageLayout = ImageLayout.Stretch;
            btnDangKy.FlatAppearance.BorderSize = 0;
            btnDangKy.FlatAppearance.MouseDownBackColor = Color.Crimson;
            btnDangKy.FlatAppearance.MouseOverBackColor = Color.IndianRed;
            btnDangKy.FlatStyle = FlatStyle.Flat;
            btnDangKy.ForeColor = SystemColors.ControlLight;
            btnDangKy.Location = new Point(444, 251);
            btnDangKy.Margin = new Padding(3, 2, 3, 2);
            btnDangKy.Name = "btnDangKy";
            btnDangKy.Size = new Size(189, 30);
            btnDangKy.TabIndex = 30;
            ...
            // btnQuenMatKhau
            // 
            btnQuenMatKhau.BackColor = Color.FromArgb(0, 0, 0, 0);
            btnQuenMatKhau.BackgroundImage = (Image)resources.GetObject("btnQuenMatKhau.BackgroundImage");
            btnQuenMatKhau.BackgroundImageLayout = ImageLayout.Stretch;
            btnQuenMatKhau.FlatAppearance.BorderSize = 0;
            btnQuenMatKhau.FlatAppearance.MouseDownBackColor = Color.Crimson;
            btnQuenMatKhau.FlatAppearance.MouseOverBackColor = Color.IndianRed;
            btnQuenMatKhau.FlatStyle = FlatStyle.Flat;
            btnQuenMatKhau.ForeColor = SystemColors.ControlLight;
            btnQuenMatKhau.Location = new Point(444, 285);
            btnQuenMatKhau.Margin = new Padding(3, 2, 3, 2);
            btnQuenMatKhau.Name = "btnQuenMatKhau";
            btnQuenMatKhau.Size = new Size(189, 30);
            btnQuenMatKhau.TabIndex = 29;
